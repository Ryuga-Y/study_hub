...
// Add reminder time selector
            ...
            DropdownButtonFormField<int>(
              ...
              items: [
                ...
                DropdownMenuItem(value: 0, child: Text('On time', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 5, child: Text('5 minutes before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 10, child: Text('10 minutes before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 15, child: Text('15 minutes before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 30, child: Text('30 minutes before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 60, child: Text('1 hour before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 120, child: Text('2 hours before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 1440, child: Text('1 day before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 2880, child: Text('2 days before', overflow: TextOverflow.ellipsis)),
                DropdownMenuItem(value: 10080, child: Text('1 week before', overflow: TextOverflow.ellipsis)),
              ],
              onChanged: (value) {
